...
using RecipePELImporter.Properties;
...
namespace RecipePELImporter
{
    ...
    public class Importer : ErrorHandledService
    {
        ...
        protected override Constants.ProcessOutcome Process()
        {
            ...
            importer = new RecipePEL(Settings.Default.FilePath, Settings.Default.ArchivePath, Settings.Default.StagingTableName, Settings.Default.FormatFilePath,
