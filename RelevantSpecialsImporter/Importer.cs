...
namespace RelevantSpecialsImporter
{
    public class Importer : ErrorHandledService
    {
        ...
        protected override Constants.ProcessOutcome Process()
        {
            ...
            importer = new RelevantSpecials(Settings.Default.FilePath, Settings.Default.ArchivePath, Settings.Default.StagingTableName, Settings.Default.FormatFilePath,
