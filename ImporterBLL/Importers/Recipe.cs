...
{
    public class Recipe : ServiceImporterBase
    {
        ...
        public Recipe(string fileDirectoryPath, string archiveDirectoryPath, string stagingTableName, string formatFilePath, IEnumerable<string> fileNames,
            ...
            : base(ServiceLogger.FlatFileType.Recipe, FlatFiles.FileFormat.JSON, FlatFiles.CompressType.None,
        ...
        protected override void ProcessBespoke()
        {
            ...
            var js = new JavaScriptSerializer {MaxJsonLength = 2147483644};
            ...
            foreach (var path in UnzippedPaths)
            {
                ...
                // sanity check in case this is a featured recipe file
