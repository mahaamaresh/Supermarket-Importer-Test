...
{
    public class HealthWellbeing : ServiceImporterBase
    {
        private readonly string _fileName;

        public HealthWellbeing(string fileDirectoryPath, string fileName, string stagingTableName, string formatFilePath, string archiveDirectoryPath, string summaryReportErrorToEmailAddress,
            ...
            string daysToRun)
            : base(ServiceLogger.FlatFileType.HealthWellbeing, FlatFiles.FileFormat.TXT, FlatFiles.CompressType.Zip,
        ...
        protected override bool ExecuteDataProcessingProc()
        {
            ...
            using (var context = new WoolworthsDBDataContext())
            {
                ...
                success = (int)context.p_ImportHealthWellbeing(MasterLogId);
            }

            if (success == 0) return false;
            else if (success == 1) return true;
            else throw new ArgumentOutOfRangeException("success", "Stored Proc p_ImportHealthWellbeing returned int value that that was not equal to 1 or 0");
        }
        ...
        {
            get { return "p_ImportHealthWellbeing"; }
        }

        protected override string ResetProcName
        {
            get { return "p_ImportHealthWellbeing_Reset"; }
        }
    }
}
